...
try:
    Old_file = pd.read_csv(file_name+"/"+file_name+".csv",encoding="utf-8_sig")
    with open(file_name+'/'+file_name+'_keys.json') as f:
        a = f.read()
    arg = ast.literal_eval(a)
except:
    print(file_name + " did not found")

# In[21]:


area1 = arg['prefecture']
